...
test: $(BIN_DIR)/test_matrix $(BIN_DIR)/test_nn $(BIN_DIR)/test_infer_c
	./$(BIN_DIR)/test_matrix
	./$(BIN_DIR)/test_nn
	./$(BIN_DIR)/test_infer_c

valgrind: $(BIN_DIR)/test_matrix $(BIN_DIR)/test_nn $(BIN_DIR)/test_infer_c
...
.PHONY: all test valgrind clean lib
